...
fn generate_pr_body() -> String {
    ...
    md.push_str("Generated by [blameprompt](https://github.com/metaquity/blameprompt) \u{1f916}\n\n");
    ...
    for sha in &commits {
        ...
        if let Some(payload) = read_receipts_for_commit(sha) {
            for receipt in &payload.receipts {
                ...
                let summary = receipt.prompt_summary
                    .chars()
                    .take(60)
                    .collect::<String>();
...
fn post_pr_comment(repo: &str, pr: u32, body: &str, token: &str) -> Result<String, String> {
    ...
    if status_code == 201 {
        ...
        let comment_url = extract_json_string(response_body, "html_url")
